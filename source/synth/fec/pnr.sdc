# ============================================================
# pnr.sdc — Aggressive PnR timing constraints for fec_top
# Technology: SKY130A  |  Frequency: 50 MHz (T = 20 ns)
# More restrictive than signoff to compensate for parasitics
# estimation gap during place and route optimization.
# ============================================================
...
# Aggressive: 30% of clock period = 6 ns
set_input_delay -max 6.0 -clock clk [get_ports rst_n]
set_input_delay -min 1.5 -clock clk [get_ports rst_n]
...
# --- Output ports ---
# Aggressive: 30% of clock period = 6 ns
set_output_delay -max 6.0 -clock clk [get_ports {uart_tx dl_ready dl_out dl_en}]
set_output_delay -min 1.5 -clock clk [get_ports {uart_tx dl_ready dl_out dl_en}]
